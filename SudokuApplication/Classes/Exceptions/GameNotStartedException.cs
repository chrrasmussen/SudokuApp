...
namespace SudokuApplication
{
    ...
    class GameNotStartedException : SudokuException
    {
        public GameNotStartedException() : base() { }

        public GameNotStartedException(string errorMessage) : base(errorMessage) { }

        public GameNotStartedException(string errorMessage, Exception innerException) : base(errorMessage, innerException) { }
